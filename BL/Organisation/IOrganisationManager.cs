...
namespace COI.BL.Organisation
{
	public interface IOrganisationManager
	{
		...
		Domain.Organisation.Organisation AddOrganisation(string name, string identifier, string description, string color);
		Domain.Organisation.Organisation ChangeOrganisation(int id, string name, string identifier, string description, string color);

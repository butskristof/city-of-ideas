...
namespace COI.BL.Tests.Ideation
{
	...
	{
//		[Fact]
//		public void GetIdeations_WithEmptyRepo_ReturnsEmptyCollection()
//		{
//			// arrange
//			var ideaRepo = new Mock<IIdeaRepository>();
//			var ideationRepo = new Mock<IIdeationRepository>();
//			ideationRepo
//				.Setup(x => x.ReadIdeations())
//				.Returns(new List<Domain.Ideation.Ideation>());
//			var commentRepo = new Mock<ICommentRepository>();
//			var mgr = new IdeationManager(ideaRepo.Object, commentRepo.Object, ideationRepo.Object);
//			
//			// act
//			var result = mgr.GetIdeations();
//			
//			// assert
...
//		[Fact]
//		public void GetIdeations_WithIdeationsInRepo_ReturnsIdeations()
//		{
//			// arrange
//			var ideaRepo = new Mock<IIdeationRepository>();
//			ideaRepo
//				.Setup(x => x.ReadIdeations())
//				.Returns(new List<Ideation>() { new Ideation(), new Ideation()});
//			var commentRepo = new Mock<ICommentRepository>();
...
//			// assert
//			Assert.NotNull(result);
//			Assert.Equal(ideaRepo.Object.ReadIdeations().Count(), result.Count());
//			Assert.Equal(ideaRepo.Object.ReadIdeations(), result);
//		}
//		
//		[Fact]
